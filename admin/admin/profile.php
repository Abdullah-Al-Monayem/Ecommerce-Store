...
if (isset($_POST['re_password']))
  ...
  $password_query = mysqli_query($con,"select * from admin_info");
             ...
             <?php endif ?>
                     ...
                     <div class="col-md-4">
                        <div class="form-group bmd-form-group">
						  ...
						  <br>
						  <br>
                          <input style="background-color: #202940;" type="text" class="form-control" name="old_pass" id="npwd">
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Change Password Here</label>
						    <br>
						  <br>
                          <input style="background-color: #202940;" type="text" class="form-control" name="new_pass" id="npwd">
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">confirm Password Here</label>
						    <br>
						  <br>
                          <input style="background-color: #202940;" type="text" class="form-control" name="re_pass" id="npwd">
                        </div>
                      </div>
